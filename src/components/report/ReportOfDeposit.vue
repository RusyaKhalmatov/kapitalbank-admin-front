  ...
  <div class="main">
    ...
    <div class="amount-box" v-if="operationAmount.increase">
            <span class="amount-box-child">
                ...
                <div v-for="(item, indexOther) in operationAmount.increase.wallet"
                     :key="`increaseWallet-${indexOther}`">
                    <span class="column">
                ...
                <div v-for="(item, indexOther) in operationAmount.increase.account"
                     :key="`increaseAccount-${indexOther}`">
                    <span class="column">
                        <p class="amount-text">{{ item.cardType }} ({{ item.currency }}):</p>
                        <p class="amount-value">{{ item.amount / 100|number-format }} {{ item.currency }}</p>
                    </span>
                ...
                <span class="column">
                    <v-spacer></v-spacer>
                    <p
                      class="amount-value">{{ (operationAmount.increase.our[2].amount + operationAmount.increase.wallet[1].amount + operationAmount.increase.account[1].amount) / 100 | number-format }} USD</p>
                </span>
            </span>
      <span class="amount-box-child">
                ...
                <div v-for="(item, indexOther) in operationAmount.decrease.wallet"
                     :key="`increaseWallet-${indexOther}`">
                    <span class="column">
                        <p class="amount-text">{{ item.cardType }} ({{ item.currency }}):</p>
                        <p class="amount-value">{{ item.amount / 100|number-format }} {{ item.currency }}</p>
                ...
                <div v-for="(item, indexOther) in operationAmount.decrease.account"
                     :key="`increaseAccount-${indexOther}`">
                    <span class="column">
                        <p class="amount-text">{{ item.cardType }} ({{ item.currency }}):</p>
                        <p class="amount-value">{{ item.amount / 100|number-format }} {{ item.currency }}</p>
                ...
                <span class="column">
                    <v-spacer></v-spacer>
                    <p
                      class="amount-value">{{ (operationAmount.decrease.our[2].amount + operationAmount.decrease.wallet[1].amount + operationAmount.decrease.account[1].amount) / 100 | number-format }} USD</p>
                </span>
            </span>
      <span class="amount-box-child">
                <h2>Общая сумма</h2>
