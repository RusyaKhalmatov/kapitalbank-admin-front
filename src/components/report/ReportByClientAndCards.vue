<template>
  <div class="main">
    ...
    <div class="d-flex flex-wrap checkbox">
      <v-checkbox v-for="(item,index) in accountTypeData" :key="index" v-model="accountType" :label="item"
    ...
    >
      <template slot="items" slot-scope="props">
        <tr>
          <td v-if="props.item.phone.split(':').length>1">{{ props.item.phone.split(':')[0] }} - Удален:
