        ...
        <div class="amount-box" v-if="operationAmount.our">
            <span class="amount-box-child">
                ...
                <span class="column">
                    ...
                    <p class="amount-value">{{(operationAmount.our[0].amount+operationAmount.our[1].amount) / 100 | number-format}} {{operationAmount.our[0].currency}}</p>
                </span>
            </span>  
            <span class="amount-box-child">
                ...
                <span class="column">
                    <p class="amount-value">Итого:</p>
                    <p class="amount-value">{{(operationAmount.other[0].amount+operationAmount.other[1].amount) / 100 | number-format}} {{operationAmount.other[0].currency}}</p>
                </span>
            ...
            <span class="amount-box-child">
                ...
                <span class="column">
                    <p class="amount-value">Итого:</p>
                    <p class="amount-value">{{(operationAmount.wallet[0].amount) / 100 | number-format}} {{operationAmount.wallet[0].currency}}</p>
                </span>
            </span> 
            <span class="amount-box-child">
                ...
                <span class="column">
                    <p class="amount-value">Итого:</p>
                    <p class="amount-value">{{(operationAmount.account[0].amount) / 100 | number-format}} {{operationAmount.account[0].currency}}</p>
                </span>
            </span>  
            <span class="amount-box-child">
                <h2>Общая сумма</h2>
...
export default {
    ...
    methods:{
        ...
        getExcel(){
            ...
            this.loader = true;
            this.$http.post(this.$store.getters.newApiUrl + '/report/loan/v2/excel', this.data)
            .then(response => {
                this.loader = false;
        ...
        loadAmount(){
            this.$http.post(this.$store.getters.newApiUrl + '/report/loan/v2/amount', this.data)
                .then(response => {
        ...
        getList(page){
            this.loader = true;
            this.$http.post(this.$store.getters.newApiUrl + `/report/loan/v2?page=${page-1}&size=10`, this.data)
                .then(response => {
                    this.loader = false;
        ...
        getOperationsTypes() {
            this.$http.get(this.$store.getters.newApiUrl + '/report/loan/v2/type')
                .then(response => {
        ...
        getStatus(){
            this.$http.get(this.$store.getters.newApiUrl+`/report/loan/v2/status`)
            .then(response=>{
