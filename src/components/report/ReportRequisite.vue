    ...
    >
      <template slot="items" slot-scope="props">
        <tr>
          ...
          <td>
            <v-btn @click="details(props.item)" depressed small rounded>Подробнее</v-btn>
          </td>
        </tr>
      </template>
    ...
    <v-dialog v-model="dialog" persistent max-width="650px">
      <v-card>
        ...
        <v-card-text>
          ...
          <v-text-field label="Время создания" :value="dialogData.startTime|timestamp-to-date"
                        readonly=""></v-text-field>
          <v-text-field label="Время окончания" :value="dialogData.endTime|timestamp-to-date"
                        readonly=""></v-text-field>
          <v-text-field label="Время окончания" :value="dialogData.endTime|timestamp-to-date"
                        readonly=""></v-text-field>
