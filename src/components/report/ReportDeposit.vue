              ...
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                  <tr @click="props.expanded = !props.expanded">
                    ...
                    <td>{{ !!props.item.receiverName ? props.item.receiverName : props.item.name }}</td>
...
export default {
  ...
  data() {
    return {
      ...
      filters: [
        {text: 'Открытие вкладов U', value: 'uzcard2depositOpen'},
        {text: 'Пополнение вкладов U', value: 'uzcard2depositIncrease'},
        {text: 'Уменьшение вкладов U', value: 'depositDecrease2uzcard'},
        {text: 'Закрытие вклада U', value: 'depositClose2uzcard'},
        {text: 'Открытие вкладов H', value: 'humo2depositOpen'},
        {text: 'Пополнение вкладов H', value: 'humo2depositIncrease'},
        {text: 'Уменьшение вкладов H', value: 'depositDecrease2humo'},
        {text: 'Открытие вкладов V', value: 'visa2depositOpen'},
        {text: 'Закрытие вклада H', value: 'depositClose2humo'},
        {text: 'Закрытие вклада V', value: 'depositClose2visa'},
        {text: 'Открытие вкладов', value: 'wallet2depositOpen'},
      ...
      operationsHeaders: [
        ...
        {text: "ABS ID", value: "receiverId"},
        {text: "Имя вклада", value: "name"},
  ...
  methods: {
    getTypeOperations() {
      let self = this;
      self.$http.get(self.$store.getters.newApiUrl + '/report/operationTypes')
        .then(response => {
