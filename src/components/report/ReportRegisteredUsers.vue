<template>
    <div class="main">
        ...
        <div class="button-box">
            <v-btn v-if="typesData.length!=0" dark color="primary" class="get-btn" @click="load" :loading="loader">Получить</v-btn>   
        ...
        <span class="amount-box justify-center">
            <span class="mr-2 amount-box-child-text" v-for="(item, index) in amountData.amountByUserState" :key="'state-'+index">
        ...
        <template v-if="isClick">
            <span class="search-box">
                ...
                <span style="display:flex">
                    <v-checkbox class="mx-3" v-model="types" v-for="(item,index) in typesData" :key="index" :label="item.value" :value="item.key"></v-checkbox>
                </span>
            </span>            
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    <tr>
                        ...
                        <td><v-btn @click="openDevicesBox(props.item.devices)" depressed small>показать</v-btn></td>
                    </tr>
                </template>            
            </v-data-table>
        </template>
