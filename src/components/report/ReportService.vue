                            ...
                            <v-data-table
                                ...
                                <template slot="items" slot-scope="props">
                                    <tr @click="props.expanded = !props.expanded">
                                        ...
                                        <td style="min-width:150px">{{ props.item.amount / 100 | number-format }} {{props.item.currency}}</td>
                                        ...
                                        <td>
                                            <v-btn depressed small v-if="props.item.errorInfo" @click="showErrorInfo(props.item.errorInfo)">Подробнее</v-btn>
                                        </td>
