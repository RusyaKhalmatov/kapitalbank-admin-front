        ...
        >
            <v-card>
                ...
                <div class="service-box">
                    <span :class="['service-item', {'active-class': active===item.serviceId}]" v-for="(item, i) in serviceData" :key="i" @click="setActiveService(item)">
...
export default {
    ...
    methods:{
        ...
        editLimits(){
            ...
            self.$http.put(self.$store.getters.apiUrl + '/service-limit', postData)
            .then(response => {
                self.getAllLimits();
            }, self.handleError);
        ...
        addLimits(){
            if(this.maxAmount&&this.minAmount&&this.serviceId&&this.period){
                ...
                self.$http.post(self.$store.getters.apiUrl + '/service-limit', postData)
                .then(response => {
        ...
        getAllLimits(){
            let self = this;
            self.$http.get(self.$store.getters.apiUrl + '/service-limit')
            .then(response => {
        ...
        deleteServiceLimit(id){
            //console.log(id)
            let self = this;
            self.$http.delete(self.$store.getters.apiUrl + '/service-limit', { 
                params:{
                    'id': id,
                }
            })
