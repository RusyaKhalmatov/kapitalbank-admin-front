    ...
    methods:{
        getExcel(){
            ...
            if(this.cardProduct.length!=0){
                this.$http.post(this.$store.getters.newApiUrl+`/report/virtual_card/credit/excel`, postData)
                .then(response=>{
        ...
        getAmount(){
            ...
            if(this.cardProduct.length!=0){
                this.$http.post(this.$store.getters.newApiUrl+`/report/virtual_card/credit/amount`, postData)
                .then(response=>{
        ...
        virtualCardsCredit(page){
            ...
            if(this.cardProduct.length!=0){
                ...
                this.$http.post(this.$store.getters.newApiUrl+`/report/virtual_card/credit?page=${page-1}&size=10`, postData)
                .then(response=>{
                    // console.log(response.data.data);
