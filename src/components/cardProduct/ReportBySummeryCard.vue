  ...
  <div class="statistics">
    ...
    <template>
      ...
      <div class="card-products" v-if="!isEmpty(summeryData)">
                <span
                  :class="['card-products-child', { 'visa-classic' : index===0, 'visa-infinite': index===1, 'visa-platinum': index===2, 'visa-gold': index===3, 'uzcard': index===4, 'humo': index===6}]"
                  text-color="white" v-for="(value, name, index) in summeryData" :key="index">
                    <span
                      :class="['card-products-child-value', {'visa-infinite-value': index===1||index===2||index===5}]">
