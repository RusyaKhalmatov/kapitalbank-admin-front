...
export default {
  ...
  methods: {
    getList() {
      this.$http.get(`${this.prodApiUrl}/social-media`)
        .then(response => {
    ...
    edit() {
      ...
      this.$http.put(`${this.prodApiUrl}/social-media`, putData)
        .then(response => {
          this.loader = false;
          this.getList()
          this.dialog = false;
    ...
    add() {
      ...
      this.$http.post(`${this.prodApiUrl}/social-media`, postData)
        .then(response => {
          this.loader = false;
          this.getList()
          this.dialog = false;
    ...
    remove() {
      this.loader = false;
      this.$http.delete(`${this.prodApiUrl}/social-media/${this.id}`)
        .then(response => {
          this.loader = false;
          this.getList()
