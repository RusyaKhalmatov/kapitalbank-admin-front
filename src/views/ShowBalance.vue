                        ...
                        <v-data-table
                            ...
                            <template slot="items" slot-scope="props">
                                <tr>
                                    ...
                                    <td><span v-if="props.item.categoryName">{{props.item.categoryName}}: </span>{{props.item.serviceName}}</td>
            ...
            <v-card>
                ...
                <v-card-title>
                    <div class="service-box">
                        <p @click="changeService(item)" :class="{'active': serviceId===item.serviceId}" v-for="(item, i) in tmpServiceData" :key="i">{{item.categoryName}}: {{item.serviceName}}</p>
                    </div>
...
export default {
    ...
    methods:{
        ...
        editShowBalance(){
            ...
            console.log(data)
            this.$http.post(this.$store.getters.apiUrl+`/service/show-balance`, data)
            .then(response=>{
                this.getShowBalance();
        ...
        addShowBalance(){
            ...
            console.log(data)
            this.$http.put(this.$store.getters.apiUrl+`/service/show-balance`, data)
            .then(response=>{
        ...
        deleteShowBalance(){
            let self = this;
            self.$http.delete(self.$store.getters.apiUrl + "/service/show-balance/"+this.id)
                .then(response => {
        ...
        getShowBalance(){
            let self = this;
            self.data = [];
            self.$http.get(self.$store.getters.apiUrl + "/service/show-balance")
                .then(response => {
                    console.log(response.data.data)
        ...
        getServices(){
            this.$http.get(this.$store.getters.newApiUrl+`/payment-services/short`)
            .then(response=>{
                // console.log(response.data.data)
