<template>
    <div class="main">
        ...
        <div class="btns-box">
            <v-btn @click="connect" :class="[{'active-btn': active === 'btn1'}]">Пользователи, которые часто добавляют и удаляют карты</v-btn>
        ...
        <div v-if="isDisBalanceShow" style="margin: 50px 0;" class="content-box">
            ...
            <template slot="items" slot-scope="props">
                    <tr>
                        ...
                        <td>{{(props.item.absBalance/100).toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2})}}</td>
                        <td >{{(props.item.walletBalance/100).toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2})}}</td>
                        <td>{{(props.item.difference/100).toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2})}}</td>
                        <td>{{(props.item.hangAmount/100).toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2})}}</td>
