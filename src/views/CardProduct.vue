<template>
  <div class="main">
    ...
    <div class="content">
      <v-card :class="['card', {'active-class': activeClass === item.id}]" v-for="(item, index) in cardProductTypeData"
        ...
        <v-card>
          ...
          <v-card-text>
            <v-container>
              ...
              <input class="input-file" accept="image/*" type="file" @change="onImageUrlChange($event)"
                     ref="imageupload">
  ...
  export default {
    ...
    methods: {
      ...
      addItemCardProductType() {
        ...
        self.$http.post(self.prodApiUrl2 + "/card-product", postData)
          .then((response) => {
      ...
      getCurrencyRate() {
        let self = this;
        self.$http.get(self.prodApiUrl2 + "/b2/currency-rate")
          .then((response) => {
      ...
      editItemCardProductType() {
        ...
        self.$http.put(self.prodApiUrl2 + "/card-product/" + this.editedId, putData)
          .then((response) => {
            console.log(response.data);
      ...
      deleteItemCardProduct(id) {
        let self = this;
        self.$http.delete(self.prodApiUrl2 + "/card-product/" + id)
          .then((response) => {
            console.log(response.data);
            self.details(this.detailId);
          }, self.handleError);
      ...
      uploadImage(id, xUrl, val) {
        ...
        self.$http.post(self.prodApiUrl2 + "/card-product/" + xUrl + "/" + id, data, {headers: {'Content-Type': 'multipart/form-data'}})
          .then((response) => {
            self.addItemDialog = false;
            self.editItemDialog = false;
            // self.freeDatas();
      ...
      uploadLogo(id) {
        ...
        self.$http.post(self.prodApiUrl2 + "/card-product-type/logoUrl/" + id, data, {headers: {'Content-Type': 'multipart/form-data'}})
          .then((response) => {
      ...
      details(typeId) {
        ...
        self.$http.get(self.prodApiUrl2 + "/card-product/type/" + typeId)
          .then((response) => {
      ...
      getCardProduct(id) {
        ...
        self.$http.get(self.prodApiUrl2 + "/card-product/" + id)
          .then((response) => {
      ...
      getCardProductType() {
        ...
        self.$http.get(self.prodApiUrl2 + "/card-product-type")
          .then((response) => {
            console.log(response.data);
      ...
      deleteCardProductType() {
        ...
        self.$http.delete(self.prodApiUrl2 + "/card-product-type/" + this.selectedId)
          .then((response) => {
            console.log(response.data);
            self.getCardProductType();
          }, self.handleError);
      ...
      addCardProductType() {
        ...
        self.$http.post(self.prodApiUrl2 + "/card-product-type", postData)
          .then((response) => {
            console.log(response.data);
      ...
      editCardProductType() {
        ...
        self.$http.put(self.prodApiUrl2 + "/card-product-type/" + this.id, putData)
          .then((response) => {
            console.log(response.data);
            if (self.isChangeFile)
              self.uploadLogo(response.data.data.id)
